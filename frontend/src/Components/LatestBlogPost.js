                ...
                <SwiperSlide>
                    ...
                    <div className="blog-post__content text-center">
                        ...
                        <div class="articleMeta d-flex flexJustifyCenter">
                            <span className="articleAuthor"><span>By</span> Mr Admin</span>
                            <span>/</span>
                            <span className="articlePublish pull-left"><i class="fa fa-calendar-o" aria-hidden="true"></i>June 18, 2019</span>
                         </div>
                    ...
                    <Link className="btnReadMore" href="/blogs/news/summer-garden-tips-7" title="Read More">
                         + Read More
                    </Link>
                    </div>
                </SwiperSlide>
